...
function main(msg) {
    ...
    if (!msg.hasOwnProperty('provider_endpoint')) {
        return Promise.reject('missing provider_endpoint property for locating the AMQP event feed');
    }
    var url = msg.provider_endpoint;
