...
var amqpContainer = require('rhea');
var AmqpUtils = require('./lib/amqpUtils.js');
var amqpUtils = new AmqpUtils(amqpContainer, logger);
...
function init(server) {
    ...
    .then(client => {
        ...
        providerUtils.amqpUtils = amqpUtils;
        amqpUtils.providerUtils = providerUtils;
